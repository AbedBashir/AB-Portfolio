...
export const Contact: React.FC = () => {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="section bg-slate-50 dark:bg-navy"
    >
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://www.linkedin.com/in/abedbashir/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 bg-white dark:bg-navy-light rounded-md text-slate-dark dark:text-slate hover:text-primary-500 dark:hover:text-primary-500 transition-colors shadow-sm"
                  aria-label="LinkedIn"
          ...
          <motion.div variants={itemVariants}>
            <form
              ...
              className="bg-white dark:bg-navy-light p-6 rounded-lg shadow-custom"
            >
              {isSubmitted ? (
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-sm font-medium text-slate-dark dark:text-slate mb-2"
                      >
                        Your Name
                      </label>
                      <input
